...
<html>
  ...
  <body>
  	<div class="info_m">
	<form id="gform" action="${ROOT_PATH}/ManagerTaskController/addzy" method="post" enctype="multipart/form-data">
		...
		<div class="info_item info_item_x">
			<label>标题：<input type="text" name="title" maxlength="100"/></label>
		</div>
		<div class="info_item info_item_x">
			<label>内容：<textarea name="content" style="width:400px;height:120px;"></textarea> </label>
		</div>
		<div class="info_item info_item_x">
			<label>附件：<input type="file" name="img" maxlength="100"/></label>
		</div>
		<div class="info_item">
